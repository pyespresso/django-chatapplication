...
class UnprocessableEntity(HttpError):
    ...
    Indicates that the request could not be processed because of semantic errors in the request.
    """
    status_code = 422

    def __init__(self, message='The sent data is not acceptable.', error_code=None, errors=None):
        super(UnprocessableEntity, self).__init__(self.status_code, message, error_code, errors)
...
class Locked(HttpError):
    ...
    def __init__(
        self, message='This resource is currently locked! Please try again later.', error_code=None, errors=None
    ):
